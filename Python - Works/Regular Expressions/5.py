# WAP for | - Alteration regular Expression
# | finds two alternative strings of the pattern from the string
...
regex = re.finditer(r'Python|Rossum', str)
for reg in regex:
    print(reg)

regex1 = re.findall(r'Python|Rossum', str)
print(regex1)
print(len(regex1))