# WAP for \w regular Expression
# \w AlphaNumeric characters in the string (a-z A-Z 0-9 _)
# \W (Symbols)Opposite of AlphaNumeric characters in the string (^a-z A-Z 0-9 _) or (! @ # $ % ^ & * ( ) - + = ` ~ / \ | {} [] : ; " ' \n)
...
regex = re.finditer(r'\W', str)
for reg in regex:
    print(reg)
    
regex1 = re.findall('\W', str)
print(regex1)
print(len(regex1))